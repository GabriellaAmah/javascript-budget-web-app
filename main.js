...
let budgetArea = document.getElementById("budgetContainer");
...
let expenseArea = document.getElementById("expenseAmount");
...
function currentIncome() {
  ...
  let balance = budgetText.textContent - currentExpenses.textContent;
...
insertBudgetButton.addEventListener("click", function () {
  if (inputedBudget.value === "") {
    ...
    budgetText.textContent = inputedBudget.value;
    currentBalance.textContent = inputedBudget.value;
  }

  return (inputedBudget.value = ""), (budgetArea.hidden = true);
});
...
expenseButton.addEventListener("click", function () {
  if (expenseText.value == "" || expenseAmount.value == "") {
    ...
    div.className = "expenseAmountCard";
